(ns advertising-marketing.advisor
  "CampaignAdvisor — proposes an advertising-and-marketing operation
  (produce a campaign asset, publish a campaign asset, publish a claim
  without substantiation review, target a protected-category audience
  segment) for a registered campaign. The advisor is swappable:
  ...
  and has no notion of campaign provenance or unsubstantiated-claim/
  protected-category risk; `advertising-marketing.governor` is the
  independent system that decides whether the proposal may proceed,
  per the itonami actor pattern.

  A proposal is a map:
    {:op :produce|:publish|:publish-unsubstantiated-claim|:target-protected-category
...
(defn- infer
  ...
  {:op op
   ...
   :rationale (str "proposed " (name op) " for campaign " (:campaign-id request))})
...
(def ^:private system-prompt
  "You are an advertising-and-marketing advisor. Given a campaign
